  ...
  <div class="dashboard-vet-container">
    ...
    <main class="dashboard-main">
      ...
      <section class="welcome-section">
        ...
        <p>Bienvenido, <strong>{{ vetName }}</strong>. Aquí puedes gestionar tus citas, mascotas y servicios.</p>
      </section>
      ...
      <section class="stats-section">
        ...
        <div class="stats-grid">
          ...
          <div class="stat-item">
            <span class="stat-number">{{ stats.mascotas }}</span>
...
const fetchVetData = async () => {
  ...
  if (vetData) vetName.value = vetData.nombre_completo.split(' ')[0]
}
...
const fetchStats = async () => {
  ...
  const { data: mascotas } = await supabase
    ...
    .select('id')
    .eq('id_veterinario', user.id)
  stats.value.mascotas = mascotas?.length || 0
  stats.value.myPets = mascotas?.length || 0
